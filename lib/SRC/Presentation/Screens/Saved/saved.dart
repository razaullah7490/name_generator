...
const SavedScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              appBar: CustomAppbar( autoleading: true , title: 'Saved', trailing: SvgPicture.asset(Assets.dots),  
               ),
      body: Column(
        children: [
          Expanded(
  ...
  builder: (BuildContext context) {
    return const CustomDIalog();
                      ...
                      child: SavedWord(tapoption:  RoundAvatar( issvg: true, icon: Assets.bookmarkfilled,  haveborder: true,  padding: 10.sp, imageheight: 12.h, imagewidth: 12.w,),
                ),
                    ),
                  )
                ],
